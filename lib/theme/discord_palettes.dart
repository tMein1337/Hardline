...
abstract final class DiscordPalettes {
  ...
  static const dark = DiscordColors(
    slots: {
      ...
      DiscordSlot.voiceSpeakingRing: Color(0xFF23A55A),
      DiscordSlot.voiceMutedIcon: Color(0xFFF23F42),
      DiscordSlot.voiceDeafenedIcon: Color(0xFFF23F42),
      DiscordSlot.voiceParticipantRow: Color(0x00000000),
      DiscordSlot.voiceParticipantRowHover: Color(0xFF35373C),
      DiscordSlot.voiceControlBar: Color(0xFF232428),
      DiscordSlot.voiceControlIcon: Color(0xFFB5BAC1),
      DiscordSlot.voiceControlIconActive: Color(0xFF23A55A),
      DiscordSlot.voiceControlDanger: Color(0xFFF23F42),
      DiscordSlot.videoTileBackground: Color(0xFF000000),
      DiscordSlot.videoTilePlaceholder: Color(0xFF1E1F22),
      DiscordSlot.volumeSliderTrack: Color(0xFF4E5058),
      DiscordSlot.volumeSliderActive: Color(0xFF5865F2),
    },
  ...
  static const darkClassic = DiscordColors(
    slots: {
      ...
      DiscordSlot.voiceError: Color(0xFFED4245),
      DiscordSlot.voiceSpeakingRing: Color(0xFF3BA55D),
      DiscordSlot.voiceMutedIcon: Color(0xFFED4245),
      DiscordSlot.voiceDeafenedIcon: Color(0xFFED4245),
      DiscordSlot.voiceParticipantRow: Color(0x00000000),
      DiscordSlot.voiceParticipantRowHover: Color(0xFF3A3C43),
      DiscordSlot.voiceControlBar: Color(0xFF292B2F),
      DiscordSlot.voiceControlIcon: Color(0xFFB9BBBE),
      DiscordSlot.voiceControlIconActive: Color(0xFF3BA55D),
      DiscordSlot.voiceControlDanger: Color(0xFFED4245),
      DiscordSlot.videoTileBackground: Color(0xFF000000),
      DiscordSlot.videoTilePlaceholder: Color(0xFF202225),
      DiscordSlot.volumeSliderTrack: Color(0xFF4F545C),
      DiscordSlot.volumeSliderActive: Color(0xFF5865F2),
    },
    avatarPalette: _avatarRamp,
  );
  ...
  static const light = DiscordColors(
    slots: {
      ...
      DiscordSlot.voiceError: Color(0xFFD83C3E),
      DiscordSlot.voiceSpeakingRing: Color(0xFF248046),
      DiscordSlot.voiceMutedIcon: Color(0xFFD83C3E),
      DiscordSlot.voiceDeafenedIcon: Color(0xFFD83C3E),
      DiscordSlot.voiceParticipantRow: Color(0x00000000),
      DiscordSlot.voiceParticipantRowHover: Color(0xFFE0E1E5),
      DiscordSlot.voiceControlBar: Color(0xFFEBEDEF),
      DiscordSlot.voiceControlIcon: Color(0xFF4E5058),
      DiscordSlot.voiceControlIconActive: Color(0xFF248046),
      DiscordSlot.voiceControlDanger: Color(0xFFD83C3E),
      DiscordSlot.videoTileBackground: Color(0xFF000000),
      DiscordSlot.videoTilePlaceholder: Color(0xFFD4D7DC),
      DiscordSlot.volumeSliderTrack: Color(0xFFC4C9CE),
      DiscordSlot.volumeSliderActive: Color(0xFF5865F2),
    },
    avatarPalette: _avatarRamp,
  );
